...
export default function DosIntro() {
    ...
    return(
        ...
        <>
            ...
            <h1><center>Do's Intro: Purpose - Belief</center></h1>
            <hr width ="100%" align = "center" size="1"></hr>
            <br></br>
            <h3><center>What Our Purpose Is - The Simple "Bottom Line"</center></h3><br></br>
            
            <img src="../img/hrshdnb.jpg" align="left" alt="Horsehead nebula in Orion"></img>
            <img src="img_5terre_wide.jpg" alt="Cinque Terre" width="1000" height="300"></img>
                        <p>
